...
public class DeliveryPendingOrderFragment extends Fragment {
    ...
    String deliveryId = "fztd1TRZUjO7ooJNGe9VEihET7F3";
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        DatabaseReference data = databaseReference.child(Objects.requireNonNull(snapshot.getKey())).child("OtherInformation");
                    ...
                    swipeRefreshLayout.setRefreshing(false);
                    Toast.makeText(getContext(),"NO ORDERS\nDO GOOD WORK, ORDERS WILL COME",Toast.LENGTH_LONG).show();
                }
            }
